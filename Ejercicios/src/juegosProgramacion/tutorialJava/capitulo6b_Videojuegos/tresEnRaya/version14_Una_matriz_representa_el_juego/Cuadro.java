...
/*	private void pintaImagenesVectoriales (Graphics g) {
	...
	private void pintaImagenesMapasDeBits (Graphics g) {
		...
		if (this.jugadorPropietario == TresEnRaya.JUGADOR_1) { // Comprueba jugador 1 - Pinto imagen jugador 1
			imagenAPintar = SpritesRepository.getInstance().getSprite(SpritesRepository.IMAGEN_JUGADOR_1);
		} 
		if (this.jugadorPropietario == TresEnRaya.JUGADOR_2) { // En este caso el jugador 2 - Pinto imagen jugador 2
